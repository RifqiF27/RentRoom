<template>
      ...
      <div class="row col-md-4 p-2">
        <div class="input-group mb-2">
          ...
          <div class="input-group-append">
            <button @click.prevent="sendFilter" class="btn btn-primary">
  ...
  <div class="container mb-2">
    <div class="row d-flex justify-content-center">
      <div class="col-md-8">
        <div class="p-4 mt-3 m-3">
          <h3 class="heading mt-2 text-center">Hi! How can we help You?</h3>
          <div class="d-flex justify-content-end px-5">
            <div class="search border border-secondary">
              <input
                v-model="input.location"
                type="text"
                class="search-input"
                ...
                name=""
              />
              <a @click.prevent="sendFilter" href="#" class="search-icon">
...
export default {
  ...
  methods: {
    ...mapActions(useCounterStore, ["filterLocation", "fetchLodgings"]),
    sendFilter() {
      this.filterLocation(this.input);
      this.fetchLodgings();
    },
  },
  created() {
